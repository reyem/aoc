...
public class Day6Copy {
    ...
    public static void main(final String... args) throws IOException {
        BufferedReader reader = new BufferedReader(new InputStreamReader(Day6.class.getClassLoader().getResourceAsStream("day6/input.txt")));
        List<String> stringList = new ArrayList<>();
        String line;
        while ((line = reader.readLine()) != null) {
            stringList.add(line);
        }
        Day6Copy day6 = new Day6Copy();
        System.out.println(day6.runPart2(stringList));
    }
}
